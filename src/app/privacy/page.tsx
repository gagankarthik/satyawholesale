...
export default function Privacy() {
  return (
    <LegalPage
      ...
      updated="June 2026"
      intro="Satya Wholesale serves licensed retail businesses, not the general public. This policy explains what business information we collect to operate trade accounts and fulfill orders, and how we handle it."
      sections={[
        { h: "Information we collect", p: [
          "Business account data you provide when applying for trade access: store name, contact name, email, phone, business and tobacco license numbers, and delivery address.",
        ...
        { h: "How we use it", p: [
          "To verify eligibility for a trade account, process and deliver orders, manage invoicing and terms, and provide support.",
        ...
        { h: "Retention & security", p: [
          "We retain trade-account and transaction records for the period required by applicable tax and tobacco regulations. Access is restricted to authorized staff and protected with administrative and technical safeguards.",
        ] },
        { h: "Your choices", p: [
