...
const STEPS = [
  { n: "01", h: "Apply for trade access", p: "Submit your business and tobacco licenses online — no cost and no obligation." },
    ...
    <section id="process" className="process">
      <div className="wrap">
        <div className="shead reveal">
          ...
          <p>Becoming a Satya trade account is straightforward — most stores are placing their first order within a day.</p>
        </div>
